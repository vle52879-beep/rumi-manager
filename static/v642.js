...
/* RUMI 6.4.5 — bulk admin controls, 56h/week and registered-applicant reassignment. */
(() => {
  const VERSION = '6.4.5';
  ...
  if (missingDependencies642.length) {
    console.error(`RUMI 6.4.5 không thể khởi tạo: thiếu ${missingDependencies642.join(', ')}`);
