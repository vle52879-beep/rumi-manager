    ...
    <div class="studio-content">
      ...
      <div class="studio-product" aria-hidden="true">
        ...
        <div class="studio-boba-wrap">
          <div class="studio-boba-fx fx-a"></div>
          <div class="studio-boba-fx fx-b"></div>
          <div class="studio-boba-orbit orbit-a"></div>
          <div class="studio-boba-orbit orbit-b"></div>
          <div class="studio-boba-orbit-dot dot-a"></div>
          <div class="studio-boba-orbit-dot dot-b"></div>
...
(async function boot(){
  ...
  try {
    ...
    $('#app-root').classList.add('hidden');
    $('#auth-root').classList.remove('hidden');
    $('#auth-root').innerHTML=authLayout(`<div class="auth-card"><span class="eyebrow">RUMI MANAGER</span><h2>Chưa thể mở đăng nhập</h2><p>${esc(e.message)}</p><div class="auth-hint">Vui lòng kiểm tra kết nối hệ thống rồi tải lại trang.</div></div>`);
  }
})();
