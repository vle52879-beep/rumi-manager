#!/usr/bin/env python3
"""Verify RUMI v6.2 Supabase objects without changing business data."""
...
def main():
    ...
    if ok != len(TABLES):
        print("Chạy đầy đủ migration đến sql/SUPABASE_RUMI_V6_2_ATTENDANCE_ALERTS.sql.")
        raise SystemExit(1)
